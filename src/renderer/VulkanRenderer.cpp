...
void _VulkanRenderer_Impl::createGraphicsPipelines()
{
	...
	// create main pipeline
	{
...

		{
			...
			VkPipelineDepthStencilStateCreateInfo pre_pass_depth_stencil = {};
			pre_pass_depth_stencil = depth_stencil;
			pre_pass_depth_stencil.depthCompareOp = VK_COMPARE_OP_LESS;
			pre_pass_depth_stencil.depthWriteEnable = VK_TRUE;
			
			pre_pass_depth_stencil.sType = depth_stencil.sType;
			pre_pass_depth_stencil.pNext = depth_stencil.pNext;
			pre_pass_depth_stencil.flags = depth_stencil.flags;
			pre_pass_depth_stencil.depthTestEnable = depth_stencil.depthTestEnable;
			pre_pass_depth_stencil.depthBoundsTestEnable = depth_stencil.depthBoundsTestEnable;
			pre_pass_depth_stencil.stencilTestEnable = depth_stencil.stencilTestEnable;
			pre_pass_depth_stencil.front = depth_stencil.front;
			pre_pass_depth_stencil.back = depth_stencil.back;
			pre_pass_depth_stencil.minDepthBounds = depth_stencil.minDepthBounds;
			pre_pass_depth_stencil.maxDepthBounds = depth_stencil.maxDepthBounds;
			...
			vk::ResultValue<vk::Pipeline> RetVKPiple = device.createGraphicsPipeline(vk::PipelineCache(), depth_pipeline_info, nullptr);
			depth_pipeline = VRaii<vk::Pipeline>(RetVKPiple.value, raii_pipeline_deleter);
		}
	}
}
